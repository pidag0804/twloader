...
$dbhost = 'localhost';			// 數據庫服務器
$dbuserb = 'i7f2_tbupus_loa';			// 數據庫用戶名
$dbpwb =   'LJBC9T0Rxdk';				// 數據庫密碼
$dbnameb = 'i7f2_tbupus_loader';	

$dbb = new mysqlclass;
$dbb->connect($dbhost,$dbuserb,$dbpwb,$dbnameb);

unset($dbhost,$dbuserb,$dbpwb,$dbnameb, $pconnect);
