...
if ( $isAllPay ) {
    include_once('../include/Opay.Payment.Integration.php');
/*
* 接收訂單資料產生完成的範例程式碼。
*/
try {
    $oPayment = new OpayAllInOne();
    /* 服務參數 */
    $oPayment->HashKey = "wBYNgUHXigY3lT5V";
    $oPayment->HashIV = "y09BCfA0y2olYq4D";
    $oPayment->MerchantID = "1000220";
    /* 取得回傳參數 */
