...
<script type="text/javascript" src="style/js/formapply1.js"></script>
...
<div class="white-wrapper" id="Title_buy"> 
  ...
  <div class="inner">
    ...
    <div class="intro"><font color=red size=5>ATM匯款開通時間約15-30分鐘<br>海外地區需使用信用卡付費及其他付款管道或繳費問題請洽Line客服 : @820mdvjx</font></div>
    ...
    <!-- Begin Form -->
      <div class="form-container">
        ...
        <form class="forms" name="applyForm" id="applyForm" action="<?php echo $testing ? "a_applyec_tlpaya.php" : "a_applyec_tlpayt.php"; ?>" method="post">
          <fieldset>
            <ol>
