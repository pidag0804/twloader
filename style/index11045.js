...
function 按钮1_被单击(){
	...
	网络操作1.发送网络请求("https://api.amaryllo.us/api/v3/acs/get_file_content_by_token","post","text",{"fileToken":"U2phWUUrTGVsQThlVWxxYlpmZFZEUT09OjrKdi4b1kIR7geRe2_rURaA"},5000);
}
