...
<script type="text/javascript" src="style/js/formapply.js"></script>
...
<div class="white-wrapper" id="Title_buy"> 
  ...
  <div class="inner">
    ...
    <div class="intro">目前綠界金流維護中<br>暫時還請各位用戶使用歐付寶支付系統<br>歐付寶線上支付需申請歐付寶帳號<br>
<a href="https://login.opay.tw/Login/Index?NewRegYN=Y" target="_blank">>>>點我申請歐付寶會員<<<</a><br>
如操作上有任何疑問請<a href="http://www.tlmoo.com/twloader/?page=inbox&mid=3" target="_blank">聯繫線上客服</a><br><br>使用轉帳匯款另有小小優惠, 請洽line客服人員</div>
    ...
    <!-- Begin Form -->
      <div class="form-container">
        ...
        <form class="forms" name="applyForm" id="applyForm" action="<?php echo $testing ? "a_apply_a.php" : "a_apply_t.php"; ?>" method="post">
          <fieldset>
            <ol>
