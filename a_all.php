...
if ( $dataCheck == 1 ) {
	...
	*/
	...
	$data = array(
		...
		'PaymentType'       => 'aio',
		'ReturnURL'         => 'http://www.tlmoo.com/twloader/liftet/liftet.php',
...
<button onclick="document.getElementById('__allpayForm').submit();" title="Pay" style="height=400px;width=800px;"> 點我索取超商繳款代碼 </button>
