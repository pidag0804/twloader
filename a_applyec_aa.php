...
"amt" => $payMoney,
"prd_desc" => $prd_desc,
"ok_url" => "http://www.tlmoo.com/twloader/liftet/ECplay.php?wa=2",
);
*/
...
$obj->HashKey     = 'mKkuMv1d8bxEm5PF';
$obj->HashIV      = '0Yp8cbBnyKIEVyik';
$obj->MerchantID  = '3277353';
...
//基本參數(請依系統規劃自行調整)
$obj->Send['ReturnURL']         = "http://www.tlmoo.com/twloader/liftet/ECpay.php?wa=3";    //付款完成通知回傳的網址
