            ...
            <form class="forms" name="applyForm" id="applyForm" action="<?php echo $testing ? "a_tlapplyec_a.php" : "a_tlapplyec_t.php"; ?>" method="post">
              <fieldset>
                ...
                <div id="btnAdd" style="width:52%; float:left; display:block; margin-bottom:15px;">
                    <i class="icon-plus-circle awe colorful" style="background-color:green; cursor:pointer;" onclick="editFrame('add')" id="btnAdd"> &nbsp;增加帳號</i>
                </div>
                <div id="btnDel" style="width:48%; float:left; display:none; margin-bottom:15px;">
                    <i class="icon-minus-circle awe colorful" style="background-color:red; cursor:pointer;" onclick="editFrame('del')" id="btnDel"> &nbsp;減少帳號</i>
                </div>
                ...
                <div id="Frame_<? echo $i; ?>" style="width:48%; float:left; <? echo ($i % 2) ? " margin-right:4%;" : "" ?><? echo ($i > 1) ? " display:none;" : "";?>">
                  <li class="form-row text-input-row">
                    <input type="text" name="game_id_<? echo $i; ?>" id="game_id_<? echo $i; ?>" class="text-input defaultText mustType mustEngNum" title="勁舞團遊戲帳號 (<? echo $i; ?>) " />
                  </li>
                  <li class="form-row text-input-row">
