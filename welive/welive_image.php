...
if($_CFG['cActived']){
	...
	function welive_ajustHeight2(self){
		self.height = self.contentWindow.document.body.scrollHeight;
	}
	...
	function ShowWeLive(me) {
		...
		if(welive_main2){
			welive_main2.innerHTML = "<iframe id=\"welive_main_frame2\" src=\"'.BASEURL.'online.php\" frameBorder=\"0\" style=\"margin:0;padding:0;width:100%;overflow:hidden;border:none;background:#FFF;\" scrolling=\"no\" onload=\"welive_ajustHeight2(this);\"></iframe>";
		}
	...
	<!--var welive_panel_main = "<div style=\"width:168px;height:100%;padding:0 12px;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src=\''.TURL.'images/panel_main.png\', sizingMethod=\'scale\');background:url(\''.TURL.'images/panel_main.png\') !important;background:none;\"><div id=\"welive_main2\" style=\"position:relative;width:144px;height:100%;background:#fff;border:1px solid #666;padding:0;margin:0;\"></div></div>";-->

	var welive_panel_main = "<div style=\"width:165px;height:100%;padding:0 12px;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src=\''.TURL.'images/panel_main.png\', sizingMethod=\'scale\');background:url(\''.TURL.'images/panel_main.png\') !important;background:;\"><div style=\"position:relative;width:143px;height:100%;background:#FFF;border:1px solid #666;padding:0;margin:0;\"><iframe id=\"welive_main_frame\" src=\"'.BASEURL.'online.php\" frameBorder=\"0\" style=\"margin:0;padding:0;width:100%;height:80px;overflow:hidden;border:none;background:#FFF;\" scrolling=\"no\" onload=\"welive_ajustHeight(this);\"></iframe></div></div>";
