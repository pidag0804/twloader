...
switch($act){
	...
	case 'setbusy': //設定為忙碌狀態
		refreshCache($uid, 'isbusy', '1'); //更新暫存
		break;

	case 'unsetbusy': //解除忙碌狀態
		refreshCache($uid, 'isbusy', '0'); //更新暫存
		break;
}
