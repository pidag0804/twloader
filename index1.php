                    ...
                    <ul id="tiny">
                        ...
                        <li><a OnClick="window.location='#'">產品介紹 / 購買</a>
                            <ul>
                                ...
                                <? if ( $User['num'] > 0 ) { ?>
                                    <li><a href="?page=apply" style="color: red">信用卡付費</a></li>
                                    <? } ?>
                                <? if ( $User['num'] > 0 ) { ?>
                                    <li><a href="?page=applyec" style="color: red">超商代碼</a></li>
                                    <? } ?>
                            </ul>
                        </li>
                        <? if ( $User['num'] > 0 ) { ?>
                            ...
                            <li><a OnClick="window.location='#'">產品下載</a>
                                <ul>
                                    ...
                                    <li><a href="?page=setup_steps">安裝教學</a></li>
                                </ul>
                            </li>
                            <? } ?>
...
<p align= center>
  <? } ?> -->
                                <div class="copyright">
                                    <p align=c enter>TwLoader © 2010 - 2021 All Rights Reserved.　　聯絡信箱：garrulous01@gmail.com　　客服時間：12:00 - 22:00　　本網採用綠界金流服務
