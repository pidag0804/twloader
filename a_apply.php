...
if ( $dataCheck == 1 ) {
	...
	if ( $payMethod == 1 ) {
		...
		$ok_url =rawurlencode('http://www.tlmoo.com/twloader/liftet/liftet.php');
...
<br /><br />
<i class="awe colorful" style="background-color:#999;">訂單編號 < 請牢記 ></i>
<i class="awe colorful" style="background-color:#999;"><? echo $ReceiptId ?></i>
<br /><br />
<i class="awe colorful" style="background-color:#999;">查詢密碼 < 請牢記 ></i>
<i class="awe colorful" style="background-color:#999;"><? echo $RndPassword ?></i>
<br /><br />
...
<b>查詢開通進度方法</b>
<br />
1. 前往【查詢系統】輸入在上表提供給您的 訂單編號 和 查詢密碼<!--<br />
2. 複製此連接，隨時進入查詢開通進度<br />
<input type="text" value="" style="padding:5px;">-->
<br /><br /><br /><br />
