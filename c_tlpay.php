...
<script type="text/javascript" src="style/js/formtlapply.js"></script>
  ...
  <div class="inner">
    ...
    <!-- Begin Form -->
      <div class="form-container">
        ...
        <form class="forms" name="applyForm" id="applyForm" action="<?php echo $testing ? "a_tlpay_a" : "a_tlpay_t"; ?>" method="post">
          <fieldset>
            <ol>
