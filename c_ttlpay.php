...
<script type="text/javascript" src="style/js/tlpay.js"></script>
  ...
  <div class="inner">
    ...
    <!-- Begin Form -->
      <div class="form-container">
        ...
        <form class="forms" name="applyForm" id="applyForm" action="<?php echo $testing ? "a_tlpay_a1" : "a_tlpay_t1"; ?>" method="post">
          <fieldset>
            <ol>
